...
- `page.tsx` — server component: `getVendorSession` + `listPrintJobs` + `listActiveLocations` (`@/lib/print-locations`), renders `JobHistoryTable`.
